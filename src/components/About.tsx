      ...
      <div className="container px-4 md:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div className="space-y-8 max-w-lg">
            ...
            <div className="space-y-5 text-sm md:text-[15px] leading-[1.8] text-muted-foreground font-sans font-light">
              <p>{t("about_p1")}</p>
              <p>{t("about_p2")}</p>
              <p>{t("about_p3")}</p>
            </div>
            ...
            <div className="pt-4">
              <p className="text-[10px] font-sans tracking-[0.25em] uppercase text-muted-foreground/50">
                {t("about_since")}
              </p>
            </div>
          </div>
