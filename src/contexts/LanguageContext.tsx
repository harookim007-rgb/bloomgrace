...
const translations = {
  ...
  fr: {
    ...
    co_total: "Total",
    co_pay: "Payer",
    ship_info: "Informations de Livraison",
    ship_country_placeholder: "Choisir le pays de livraison",
    ship_fee: "Livraison estimée",
    ship_eta: "Livraison estimée",
    ship_days: "jours",
    ship_not_set: "Veuillez configurer les frais de livraison.",
    currency: "€",
    currency_suffix: "",
  },
  pt: {
    ...
    co_total: "Total",
    co_pay: "Pagar",
    ship_info: "Informações de Envio",
    ship_country_placeholder: "Selecionar país de envio",
    ship_fee: "Envio estimado",
    ship_eta: "Entrega estimada",
    ship_days: "dias",
    ship_not_set: "Configure as taxas de envio no admin.",
    currency: "R$",
    currency_suffix: "",
  },
  ar: {
    ...
    ship_country_placeholder: "اختر بلد الشحن",
    ship_fee: "تكلفة الشحن التقديرية",
    ship_eta: "موعد التسليم التقديري",
    ship_days: "أيام",
    ship_not_set: "يرجى ضبط رسوم الشحن في لوحة الإدارة.",
    currency: "$",
    currency_suffix: "",
  },
  ja: {
    ...
    co_pay: "支払う",
    ship_info: "配送情報",
    ship_country_placeholder: "配送先の国を選択",
    ship_fee: "配送料の目安",
    ship_eta: "お届け予定",
    ship_days: "日",
    ship_not_set: "管理画面で配送料を設定してください。",
    currency: "¥",
    currency_suffix: "",
  },
};
